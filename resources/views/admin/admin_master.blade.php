...
<head>
    ...
    <title>DnvMaster - Панель администратора</title>
                    ...
                    <li  class="has-sub active expand" >
                        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                           aria-expanded="false" aria-controls="dashboard">
                            ...
                            <span class="nav-text">{{ __('Панель') }}</span> <b class="caret"></b>
                        </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                <img src="{{ asset('backend/assets/img/user/dnvmaster.jpg') }}" class="user-image" alt="User Image" />
                                <span class="d-none d-lg-inline-block">DnvMaster</span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <!-- User image -->
                                <li class="dropdown-header">
                                    <img src="{{ asset('backend/assets/img/user/dnvmaster.jpg') }}" class="img-circle" alt="User Image" />
                                    <div class="d-inline-block">
                                        DnvMaster <small class="pt-1">dnvmaster50@gmail.com</small>
                                    </div>
                                </li>
